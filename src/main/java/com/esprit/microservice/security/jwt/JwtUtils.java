package com.esprit.microservice.security.jwt;
...
public class JwtUtils {
    ...
    public ResponseCookie generateJwtCookie(AdminDetailsImpl adminPrincipal) {
        String jwt = generateTokenFromUsername(adminPrincipal.getUsername());
